        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StreetName1 = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShipmentTypeId = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsBreakable = table.Column<bool>(type: "bit", nullable: true),
                    ShipmentId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ShipmentsProducts", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ShipmentsProducts_Shipments_ShipmentId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ShipmentsProducts_ShipmentId",
